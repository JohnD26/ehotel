This repository contains a frontend built with React and a backend built with Express. Follow the instructions below to run both the frontend and backend.
